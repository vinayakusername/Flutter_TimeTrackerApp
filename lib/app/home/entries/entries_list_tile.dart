...
class EntriesListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          //leadingText represent the Jobs Name
          Text(model.leadingText, style: TextStyle(fontSize: fontSize)),
          Expanded(child: Container()),
          if (model.middleText != null) // middle text represent the Jobs pay
            Text(
              model.middleText,
          ...
          SizedBox(
            width: 60.0,
            child: Text(
              model.trailingText, //trailingText represent the no of hours
