...
import 'package:flutter_time_tracker_app/app/home/job_entries/entry_list_item.dart';
import 'package:flutter_time_tracker_app/app/home/job_entries/entry_page.dart';
...
class JobEntriesPage extends StatelessWidget {
  ...
  static Future<void> show(BuildContext context, Job job) async {
    ...
    await Navigator.of(context).push(
      //I have used cupertinoPageRoute() widget instead of materialPageRoute because it gives good UX in IOS.
      CupertinoPageRoute(
  ...
  Widget build(BuildContext context) {
    ...
    (
      ...
      (
        appBar: AppBar(
          ...
          [
            ...
            (
              ...
              onPressed: ()=>  EditAndAddJobPage.show(context,database: database,job: job), 
            ),
            ...
            /*
            FlatButton is removed because instead of that IconButton is add in AppBar.
            FlatButton(
              child: Text(
                'Edit',
        ...
        /*
        FloatingActionButton is removed because instead of that IconButton is add in AppBar.
